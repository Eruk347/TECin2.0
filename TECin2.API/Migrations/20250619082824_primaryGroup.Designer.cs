...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TECin2.API.Database.Entities.ApprovedComputer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ComputerLocationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ComputerLocationId");

                    b.ToTable("ApprovedComputers");
                });
            ...
            modelBuilder.Entity("TECin2.API.Database.Entities.ComputerLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TECin2.API.Database.Entities.Group", b =>
                {
                    ...
                    b.Property<TimeSpan?>("FlexibleAmount")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("TECin2.API.Database.Entities.ApprovedComputer", b =>
                {
                    b.HasOne("TECin2.API.Database.Entities.ComputerLocation", "ComputerLocation")
                        .WithMany("ApprovedComputers")
                        .HasForeignKey("ComputerLocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ComputerLocation");
                });
            ...
            modelBuilder.Entity("TECin2.API.Database.Entities.ComputerLocation", b =>
                {
                    b.Navigation("ApprovedComputers");
                });
